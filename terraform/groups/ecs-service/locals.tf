...
locals {
  ...
  service_name               = "psc-filing-api"
  container_port             = 8080
  eric_port                  = "10000"
  docker_repo                = "psc-filing-api"
  kms_alias                  = "alias/${var.aws_profile}/environment-services-kms"
  lb_listener_rule_priority  = 170
  lb_listener_paths          = ["/transactions", "/transactions/*/persons-with-significant-control","/transactions/*/persons-with-significant-control/*", "/private/transactions/*/persons-with-significant-control", "/persons-with-significant-control/healthcheck"]
  ...
  app_environment_filename   = "psc-filing-api.env"
