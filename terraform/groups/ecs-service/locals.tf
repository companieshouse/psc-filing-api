...
locals {
  ...
  lb_listener_paths          = ["/persons-with-significant-control", "/transactions/*/persons-with-significant-control","/transactions/*/persons-with-significant-control/*", "/private/transactions/*/persons-with-significant-control/*"]
